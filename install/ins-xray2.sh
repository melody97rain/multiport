...
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/‎melody97rain/multiport/main/acme.sh -o /root/.acme.sh/acme.sh
...
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/multiport/main/menu/xraay2.sh"
chmod +x port-xray
chmod +x certv2ray
chmod +x trojaan
chmod +x xraay
