...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/multiport/main/install/ssh-vpn2.sh && chmod +x ssh-vpn2.sh && screen -S ssh-vpn ./ssh-vpn2.sh
echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
#install Xray
echo -e "\e[0;32mINSTALLING XRAY CORE...\e[0m"
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/multiport/main/install/ins-xray2.sh && chmod +x ins-xray2.sh && screen -S ins-xray ./ins-xray2.sh
